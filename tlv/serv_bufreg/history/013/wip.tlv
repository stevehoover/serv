         ...
         \SV_plus
            ...
            generate
               if (W == 1) begin : gen_w_eq_1_out
                  assign o_lsb = (MDU & i_mdu_op) ? 2'b00 : gen_w_eq_1[0].lsb_w_eq_1;
                  assign o_q = gen_w_eq_1[0].qq_w_eq_1;
               end else if (W == 4) begin : gen_lsb_w_4_out  
                  assign o_lsb = (MDU & i_mdu_op) ? 2'b00 : gen_lsb_w_4[0].lsb_w_eq_4;
                  assign o_q = gen_lsb_w_4[0].qq_w_eq_4;
               end
            endgenerate
