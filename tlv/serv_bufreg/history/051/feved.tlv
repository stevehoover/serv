...
// The guts of serv_bufreg module - TLV macro implementation
\TLV serv_bufreg(/_top)
   |default
      @0
         // === COMPUTATION STAGE ===
         ...
         $data_shift_update[31:0] = $i_en ? {$i_init ? $qq : {W{$data[31] & $i_sh_signed}}, $data[31 : W]} : $data;
         
         <<1$data[31:0] = (W == 1) ? 
                          {$data_shift_update[31 : 2],
