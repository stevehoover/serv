         ...
         \SV_plus
            ...
            generate
               ...
               for (gen_lsb_w_4_i = (W != 4); gen_lsb_w_4_i < 1; gen_lsb_w_4_i++) begin : gen_lsb_w_4
                  ...
                  always \@(posedge clock) begin
                     /gen_lsb_w4[gen_lsb_w_4_i]$$lsb[1:0] <= (*i_en && *i_cnt0) ? $qq[1 : 0] : /gen_lsb_w4[gen_lsb_w_4_i]$lsb;
                     data <= *i_en ? {*i_init ? $qq : {W{*i_sh_signed & data[31]}}, data[31 : W]} : data;
                     /gen_lsb_w4[gen_lsb_w_4_i]$$data_tail[W-2:0] <= *i_en ? data[B : 1] & {B{~ *i_cnt_done}} : /gen_lsb_w4[gen_lsb_w_4_i]$data_tail;
                  end
               end
            endgenerate
