   ...
   |default
      @0
         ...
         *o_wen = ($wtrig0 & $wen0_r) | ($wtrig1 & $wen1_r);
         ...
         <<1$wtrig0_r = $wtrig0;
         '])
         <<1$wen0_r = $wcnt[0] ? *i_wen0 : $wen0_r;
         <<1$wen1_r = $wcnt[0] ? *i_wen1 : $wen1_r;
         <<1$wdata0_r[width - 1 : 0] = {*i_wdata0, $wdata0_r[width - 1 : W]};
         <<1$wdata1_r[width + W - 1 : 0] = {*i_wdata1, $wdata1_r[width + W - 1 : W]};
         ...
         $rreg[raw - 1 : 0] = $rtrig0 ? *i_rreg1 : *i_rreg0;
         m5_if_eq_block(m5_cond_width_32, 1, ['
         *o_raddr = $rreg;
         '], ['
         *o_raddr = {$rreg, $rcnt[CMSB : l2r]};
         '])
         
         *o_rdata0 = $rdata0[B : 0];
         *o_rdata1 = $rtrig1 ? *i_rdata[B : 0] : $rdata1[B : 0];
         ...
         *o_ren = $rgate & ($rcnt[l2r - 1 : 1] == 0);
         ...
         <<1$rdata1[width - 1 - W : 0] = $rtrig1 ? *i_rdata[width - 1 : W] : {{W{1'b0}}, $rdata1[width - W - 1 : W]};
         '], ['
         <<1$rdata1[width - 1 - W : 0] = $rtrig1 ? *i_rdata[W * 2 - 1 : W] : $rdata1;
         '])
         
         <<1$rtrig1 = $rtrig0;
         <<1$rreq_r = (reset && (reset_strategy != "NONE")) ? 1'b0 : *i_rreq;
         <<1$rgnt = (reset && (reset_strategy != "NONE")) ? 1'b0 : $rreq_r;
         <<1$rdata0[width - 1 : 0] = $rtrig0 ? *i_rdata : {{W{1'b0}}, $rdata0[width - 1 : W]};
