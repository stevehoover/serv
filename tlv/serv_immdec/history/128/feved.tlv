         ...
         \SV_plus
            ...
            generate
               ...
               always \@(posedge i_clk) begin
                  ...
                  i19 <= i_cnt_en ? (i_ctrl[3] ? signbit : i23) :
                         i_wb_en  ? i_wb_rdt[19] :
                                    i19;
                  ...
                  i30 <= i_cnt_en ? ((i_ctrl[1] | i_ctrl[2]) ? signbit : i14) :
                         i_wb_en  ? i_wb_rdt[30] :
                                    i30;
                  
                  i18 <= i_cnt_en ? (i_ctrl[3] ? signbit : i22) :
                         i_wb_en  ? i_wb_rdt[18] :
                                    i18;
                  ...
                  i29 <= i_cnt_en ? ((i_ctrl[1] | i_ctrl[2]) ? signbit : i13) :
                         i_wb_en  ? i_wb_rdt[29] :
                                    i29;
                  
                  i17 <= i_cnt_en ? (i_ctrl[3] ? signbit : i21) :
                         i_wb_en  ? i_wb_rdt[17] :
                                    i17;
            
                  //Bit lane 0  
                  i28 <= i_cnt_en ? ((i_ctrl[1] | i_ctrl[2]) ? signbit : i12) :
                         i_wb_en  ? i_wb_rdt[28] :
                                    i28;
