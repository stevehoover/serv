      ...
      @0
         ...
         \SV_plus
            ...
            generate
               ...
               assign /gen_immdec_w_eq4[#gen_w4]$$signbit = /gen_immdec_w_eq4[#gen_w4]$i31 & !i_csr_imm_en;               assign o_rd_addr  = rd_addr;
               assign o_rs1_addr = rs1_addr;
               assign o_rs2_addr = rs2_addr;
               always \@(posedge i_clk) begin
                  if (i_wb_en) begin
                     //Common
                     /gen_immdec_w_eq4[#gen_w4]$$i31 <= i_wb_rdt[31];
                  ...
                  if (i_cnt_en) begin
                     ...
                     i9  <= i26;
                     i26 <= i30;
                     i30 <= (i_ctrl[1] | i_ctrl[2]) ? /gen_immdec_w_eq4[#gen_w4]$signbit : i14;
                     i14 <= i18;
