...
generate
   ...
   wire       signbit = imm31 & !i_csr_imm_en;
      ...
      for (gen_shared = !SHARED_RFADDR_IMM_REGS; gen_shared < 1; gen_shared++) begin : gen_shared_imm_regs
         always @(posedge i_clk) begin
            ...
            if (i_wb_en | (i_cnt_en & i_immdec_en[1]))
              imm_b19_b12_b20 <= i_wb_en ? {i_wb_rdt[19:12],i_wb_rdt[20]} : {i_ctrl[3] ? signbit : imm_b24_b20[0], imm_b19_b12_b20[8:1]};
            if (i_wb_en | (i_cnt_en))
              imm7        <= i_wb_en ? i_wb_rdt[7]                    : signbit;

            if (i_wb_en | (i_cnt_en & i_immdec_en[3]))
              imm_b30_b25    <= i_wb_en ? i_wb_rdt[30:25] : {i_ctrl[2] ? imm7 : i_ctrl[1] ? signbit : imm_b19_b12_b20[0], imm_b30_b25[5:1]};
      ...
      for (gen_separate = SHARED_RFADDR_IMM_REGS; gen_separate < 1; gen_separate++) begin : gen_separate_imm_regs
         ...
         always @(posedge i_clk) begin
            ...
            if (i_cnt_en) begin
               imm_b19_b12_b20 <= {i_ctrl[3] ? signbit : imm_b24_b20[0], imm_b19_b12_b20[8:1]};
               imm7        <= signbit;
               imm_b30_b25    <= {i_ctrl[2] ? imm7 : i_ctrl[1] ? signbit : imm_b19_b12_b20[0], imm_b30_b25[5:1]};
   ...
   end else begin : gen_immdec_w_eq4
   reg [4:0]         rd_addr;
   reg [4:0]         rs1_addr;
   reg [4:0]         rs2_addr;
...
generate
   if (W == 1) begin : gen_w1_csr_imm_out
      assign o_csr_imm = gen_immdec_w_eq1.imm_b19_b12_b20[4];
   end else begin : gen_w4_csr_imm_out
      assign o_csr_imm[3] = gen_immdec_w_eq4.i18;
      assign o_csr_imm[2] = gen_immdec_w_eq4.i17;
      assign o_csr_imm[1] = gen_immdec_w_eq4.i16;
      assign o_csr_imm[0] = gen_immdec_w_eq4.i15;
   end
endgenerate

generate
   if (W == 1) begin : gen_w1_imm_out
      assign o_imm = i_cnt_done ? gen_immdec_w_eq1.signbit : i_ctrl[0] ? gen_immdec_w_eq1.imm_b11_b7[0] : gen_immdec_w_eq1.imm_b24_b20[0];
   end else begin : gen_w4_imm_out
      assign o_imm[3] = (i_cnt_done ? gen_immdec_w_eq4.signbit : (i_ctrl[0] ? gen_immdec_w_eq4.i10 : gen_immdec_w_eq4.i23));
      assign o_imm[2] = i_ctrl[0] ? gen_immdec_w_eq4.i9 : gen_immdec_w_eq4.i22;
      assign o_imm[1] = i_ctrl[0] ? gen_immdec_w_eq4.i8 : gen_immdec_w_eq4.i21;
      assign o_imm[0] = i_ctrl[0] ? gen_immdec_w_eq4.ii7_b2 : gen_immdec_w_eq4.ii20_b2;
   end
endgenerate
