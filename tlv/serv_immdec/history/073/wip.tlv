            ...
            generate
               ...
               wire       signbit = imm31 & !i_csr_imm_en;
                  ...
                  for (gen_separate = SHARED_RFADDR_IMM_REGS; gen_separate < 1; gen_separate++) begin : gen_separate_imm_regs
                     ...
                     // Intermediate signals for breaking dependencies
                     wire [8:0] next_imm_b19_b12_b20;
                     wire       next_imm7;
                     wire [5:0] next_imm_b30_b25;
                     wire [4:0] next_imm_b24_b20;
                     wire [4:0] next_imm_b11_b7;
                     
                     // Calculate next values for i_cnt_en case
                     assign next_imm_b19_b12_b20 = {i_ctrl[3] ? signbit : imm_b24_b20[0], imm_b19_b12_b20[8:1]};
                     assign next_imm7 = signbit;
                     assign next_imm_b30_b25 = {i_ctrl[2] ? imm7 : i_ctrl[1] ? signbit : imm_b19_b12_b20[0], imm_b30_b25[5:1]};
                     assign next_imm_b24_b20 = {imm_b30_b25[0], imm_b24_b20[4:1]};
                     assign next_imm_b11_b7 = {imm_b30_b25[0], imm_b11_b7[4:1]};
                     ...
                     always \@(posedge i_clk) begin
                        ...
                        imm_b30_b25 <= i_wb_en ? i_wb_rdt[30:25] :
                                      i_cnt_en ? next_imm_b30_b25 :
                                      imm_b30_b25;
                        
                        imm_b24_b20 <= i_wb_en ? i_wb_rdt[24:20] :
                                      i_cnt_en ? next_imm_b24_b20 :
                                      imm_b24_b20;
                        
                        imm_b11_b7 <= i_wb_en ? i_wb_rdt[11:7] :
                                     i_cnt_en ? next_imm_b11_b7 :
                                     imm_b11_b7;
                     end
                  end
