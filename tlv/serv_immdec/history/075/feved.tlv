               ...
               wire       signbit = imm31 & !i_csr_imm_en;
                  ...
                  for (gen_separate = SHARED_RFADDR_IMM_REGS; gen_separate < 1; gen_separate++) begin : gen_separate_imm_regs
                     ...
                     always \@(posedge i_clk) begin
                        ...
                        // Handle immediate signals with nested ternary to preserve dependencies
                        // First update imm7 and imm_b19_b12_b20 which are used by others
                        imm7 <= i_wb_en ? i_wb_rdt[7] :
                               i_cnt_en ? signbit :
                               imm7;
                        
                        imm_b19_b12_b20 <= i_wb_en ? {i_wb_rdt[19:12],i_wb_rdt[20]} :
                                          i_cnt_en ? {i_ctrl[3] ? signbit : imm_b24_b20[0], imm_b19_b12_b20[8:1]} :
                                          imm_b19_b12_b20;
                        
                        // Now update imm_b30_b25 which depends on imm7 and imm_b19_b12_b20[0]
                        // Use current cycle values for dependencies
                        imm_b30_b25 <= i_wb_en ? i_wb_rdt[30:25] :
                                      i_cnt_en ? {i_ctrl[2] ? (i_wb_en ? i_wb_rdt[7] : signbit) : 
                                                               i_ctrl[1] ? signbit : 
                                                               (i_wb_en ? i_wb_rdt[20] : imm_b19_b12_b20[0]), 
                                                  imm_b30_b25[5:1]} :
                                      imm_b30_b25;
                        
                        // Update imm_b24_b20 which depends on imm_b30_b25[0]
                        imm_b24_b20 <= i_wb_en ? i_wb_rdt[24:20] :
                                      i_cnt_en ? {(i_wb_en ? i_wb_rdt[25] : imm_b30_b25[0]), imm_b24_b20[4:1]} :
                                      imm_b24_b20;
                        
                        // Update imm_b11_b7 which also depends on imm_b30_b25[0]
                        imm_b11_b7 <= i_wb_en ? i_wb_rdt[11:7] :
                                     i_cnt_en ? {(i_wb_en ? i_wb_rdt[25] : imm_b30_b25[0]), imm_b11_b7[4:1]} :
                                     imm_b11_b7;
                     end
                  end
