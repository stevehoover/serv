               ...
               wire       signbit = imm31 & !i_csr_imm_en;
                  ...
                  for (gen_separate = SHARED_RFADDR_IMM_REGS; gen_separate < 1; gen_separate++) begin : gen_separate_imm_regs
                     ...
                     always \@(posedge i_clk) begin
                        ...
                        imm7 <= (i_wb_en | i_cnt_en) ? 
                               (i_cnt_en ? signbit : i_wb_rdt[7]) : 
                               imm7;
                        
                        imm_b11_b7 <= (i_wb_en | i_cnt_en) ? 
                                     (i_cnt_en ? {imm_b30_b25[0], imm_b11_b7[4:1]} : i_wb_rdt[11:7]) : 
                                     imm_b11_b7;
                        
                        imm_b24_b20 <= (i_wb_en | i_cnt_en) ? 
                                      (i_cnt_en ? {imm_b30_b25[0], imm_b24_b20[4:1]} : i_wb_rdt[24:20]) : 
                                      imm_b24_b20;
                        
                        imm_b30_b25 <= (i_wb_en | i_cnt_en) ? 
                                      (i_cnt_en ? {i_ctrl[2] ? imm7 : i_ctrl[1] ? signbit : imm_b19_b12_b20[0], imm_b30_b25[5:1]} : i_wb_rdt[30:25]) : 
                                      imm_b30_b25;
                        
                        imm_b19_b12_b20 <= (i_wb_en | i_cnt_en) ? 
                                          (i_cnt_en ? {i_ctrl[3] ? signbit : imm_b24_b20[0], imm_b19_b12_b20[8:1]} : {i_wb_rdt[19:12],i_wb_rdt[20]}) : 
                                          imm_b19_b12_b20;
                     end
                  end
