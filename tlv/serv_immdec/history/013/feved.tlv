...
generate
   if (W == 1) begin : gen_w1_csr_imm_out
      ...
      assign o_csr_imm[3] = gen_immdec_w_eq4[0].i18;
      assign o_csr_imm[2] = gen_immdec_w_eq4[0].i17;
      assign o_csr_imm[1] = gen_immdec_w_eq4[0].i16;
      assign o_csr_imm[0] = gen_immdec_w_eq4[0].i15;
   end
endgenerate
...
generate
   if (W == 1) begin : gen_w1_imm_out
      ...
      assign o_imm[3] = (i_cnt_done ? gen_immdec_w_eq4[0].signbit : (i_ctrl[0] ? gen_immdec_w_eq4[0].i10 : gen_immdec_w_eq4[0].i23));
      assign o_imm[2] = i_ctrl[0] ? gen_immdec_w_eq4[0].i9 : gen_immdec_w_eq4[0].i22;
      assign o_imm[1] = i_ctrl[0] ? gen_immdec_w_eq4[0].i8 : gen_immdec_w_eq4[0].i21;
      assign o_imm[0] = i_ctrl[0] ? gen_immdec_w_eq4[0].ii7_b2 : gen_immdec_w_eq4[0].ii20_b2;
   end
endgenerate
