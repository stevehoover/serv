      ...
      @0
         ...
         \SV_plus
            ...
            generate
               ...
               assign /gen_immdec_w_eq4[#gen_w4]$$signbit = /gen_immdec_w_eq4[#gen_w4]$i31 & !i_csr_imm_en;
               ...
               always \@(posedge i_clk) begin
                  ...
                  if (i_cnt_en) begin
                     ...
                     i10 <= i27;
                     i23 <= i27;
                     i27 <= i_ctrl[2] ? i7 : i_ctrl[1] ? /gen_immdec_w_eq4[#gen_w4]$signbit : i20;
                     i7  <= /gen_immdec_w_eq4[#gen_w4]$signbit;
                     i20 <= i15;
                     i15 <= i19;
                     i19 <= i_ctrl[3] ? /gen_immdec_w_eq4[#gen_w4]$signbit : i23;
            
                     //Bit lane 2
                     i22 <= i26;
                     i9  <= i26;
                     i26 <= /gen_immdec_w_eq4[#gen_w4]$i30;

                     i14 <= i18;
                     i18 <= i_ctrl[3] ? /gen_immdec_w_eq4[#gen_w4]$signbit : i22;
            
                     //Bit lane 1
                     i21 <= i25;
                     i8  <= i25;
                     i25 <= /gen_immdec_w_eq4[#gen_w4]$i29;

                     i13 <= i17;
                     i17 <= i_ctrl[3] ? /gen_immdec_w_eq4[#gen_w4]$signbit : i21;
            
                     //Bit lane 0
                     ii7_b2  <= i11;
                     i11   <= /gen_immdec_w_eq4[#gen_w4]$i28;
                     ii20_b2   <= i24;
                     i24   <= /gen_immdec_w_eq4[#gen_w4]$i28;

                     i12   <= i16;
                     i16   <= i_ctrl[3] ? /gen_immdec_w_eq4[#gen_w4]$signbit : ii20_b2;
