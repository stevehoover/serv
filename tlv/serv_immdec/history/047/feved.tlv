   ...
   |default
      @0
         ...
         /gen_immdec_w_eq4[W == 1 ? 0 \: -1 : 0]
            $signbit = $i31 & !i_csr_imm_en;
            $i31 = i_wb_en ? i_wb_rdt[31] : i_cnt_en ? >>1$i31 : >>1$i31;
            $i30 = i_wb_en ? i_wb_rdt[30] : 
                   i_cnt_en ? ((i_ctrl[1] | i_ctrl[2]) ? $signbit : i14) : 
                   >>1$i30;
            $i29 = i_wb_en ? i_wb_rdt[29] : 
                   i_cnt_en ? ((i_ctrl[1] | i_ctrl[2]) ? $signbit : i13) : 
                   >>1$i29;
            $i28 = i_wb_en ? i_wb_rdt[28] : 
                   i_cnt_en ? ((i_ctrl[1] | i_ctrl[2]) ? $signbit : i12) : 
                   >>1$i28;
         \SV_plus
            ...
            generate
               ...
               always \@(posedge i_clk) begin
                  ...
                  if (i_cnt_en) begin
                     ...
                     i10 <= i27;
                     i23 <= i27;
                     i27 <= i_ctrl[2] ? i7 : i_ctrl[1] ? /gen_immdec_w_eq4[0]$signbit : i20;
                     i7  <= /gen_immdec_w_eq4[0]$signbit;
                     i20 <= i15;
                     i15 <= i19;
                     i19 <= i_ctrl[3] ? /gen_immdec_w_eq4[0]$signbit : i23;
            
                     //Bit lane 2
                     i22 <= i26;
                     i9  <= i26;
                     i26 <= /gen_immdec_w_eq4[0]$i30;

                     i14 <= i18;
                     i18 <= i_ctrl[3] ? /gen_immdec_w_eq4[0]$signbit : i22;
            
                     //Bit lane 1
                     i21 <= i25;
                     i8  <= i25;
                     i25 <= /gen_immdec_w_eq4[0]$i29;

                     i13 <= i17;
                     i17 <= i_ctrl[3] ? /gen_immdec_w_eq4[0]$signbit : i21;
            
                     //Bit lane 0
                     ii7_b2  <= i11;
                     i11   <= /gen_immdec_w_eq4[0]$i28;
                     ii20_b2   <= i24;
                     i24   <= /gen_immdec_w_eq4[0]$i28;

                     i12   <= i16;
                     i16   <= i_ctrl[3] ? /gen_immdec_w_eq4[0]$signbit : ii20_b2;
