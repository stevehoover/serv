         ...
         \SV_plus
            ...
            generate
               ...
               always \@(posedge i_clk) begin
                  ...
                  i17 <= i_wb_en ? i_wb_rdt[17] : i17;
            
                  //Bit lane 0  
                  i12 <= i_wb_en ? i_wb_rdt[12] : i12;
                  i28 <= i_wb_en ? i_wb_rdt[28] : i28;
                  
                  //More Bit lane 0 conversions
                  i11 <= i_cnt_en ? i28 :
                         i_wb_en  ? i_wb_rdt[11] :
                                    i11;
                  ...
                  //More Bit lane 0 conversions continued
                  ii7_b2 <= i_cnt_en ? i11 :
                            i_wb_en  ? i_wb_rdt[7] :
                                       ii7_b2;
                  
                  ii20_b2 <= i_cnt_en ? i24 :
                             i_wb_en  ? i_wb_rdt[20] :
                                        ii20_b2;
                  ...
                  i16 <= i_wb_en ? i_wb_rdt[16] : i16;
                  rd_addr <= i_wb_en ? i_wb_rdt[11:7] : rd_addr;
                  //Bit lane 3
                  i27 <= i_cnt_en ? (i_ctrl[2] ? i7 : i_ctrl[1] ? signbit : i20) : i27;
                  i20 <= i_cnt_en ? i15 : i20;
                  i15 <= i_cnt_en ? i19 : i15;
                  i19 <= i_cnt_en ? (i_ctrl[3] ? signbit : i23) : i19;
            
                  //Bit lane 2
                  i26 <= i_cnt_en ? i30 : i26;
                  i30 <= i_cnt_en ? ((i_ctrl[1] | i_ctrl[2]) ? signbit : i14) : i30;
                  i18 <= i_cnt_en ? (i_ctrl[3] ? signbit : i22) : i18;
            
                  //Bit lane 1
                  i25 <= i_cnt_en ? i29 : i25;
                  i29 <= i_cnt_en ? ((i_ctrl[1] | i_ctrl[2]) ? signbit : i13) : i29;
                  i17 <= i_cnt_en ? (i_ctrl[3] ? signbit : i21) : i17;
            
                  //Bit lane 0
                  i28 <= i_cnt_en ? ((i_ctrl[1] | i_ctrl[2]) ? signbit : i12) : i28;
                  i16 <= i_cnt_en ? (i_ctrl[3] ? signbit : ii20_b2) : i16;
               end
