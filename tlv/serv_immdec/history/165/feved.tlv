...
\TLV
   |default
      @0
         ...
         <<1$ii7_b2 = *i_cnt_en ? $ii11 : *i_wb_en ? *i_wb_rdt[7] : $ii7_b2;
         <<1$ii20_b2 = *i_cnt_en ? $ii24 : *i_wb_en ? *i_wb_rdt[20] : $ii20_b2;
         <<1$rd_addr[4:0] = *i_wb_en ? *i_wb_rdt[11:7] : $rd_addr;
         <<1$rs1_addr[4:0] = *i_wb_en ? *i_wb_rdt[19:15] : $rs1_addr;
         <<1$rs2_addr[4:0] = *i_wb_en ? *i_wb_rdt[24:20] : $rs2_addr;
         ...
         <<1$rd_addr_w1[4:0] = *i_wb_en ? *i_wb_rdt[11:7] : $rd_addr_w1;
         <<1$rs1_addr_w1[4:0] = *i_wb_en ? *i_wb_rdt[19:15] : $rs1_addr_w1;
         <<1$rs2_addr_w1[4:0] = *i_wb_en ? *i_wb_rdt[24:20] : $rs2_addr_w1;
         ...
         <<1$imm_b30_b25[5:0] = *i_cnt_en ? {*i_ctrl[2] ? $imm7 : *i_ctrl[1] ? $signbit : $imm_b19_b12_b20[0], $imm_b30_b25[5:1]} :
                               *i_wb_en ? *i_wb_rdt[30:25] :
                               $imm_b30_b25;
         <<1$imm_b24_b20[4:0] = *i_cnt_en ? {$imm_b30_b25[0], $imm_b24_b20[4:1]} :
                               *i_wb_en ? *i_wb_rdt[24:20] :
                               $imm_b24_b20;
         <<1$imm_b11_b7[4:0] = *i_cnt_en ? {$imm_b30_b25[0], $imm_b11_b7[4:1]} :
         ...
         \SV_plus
            ...
            m5_if_eq_block(m5_cond_w_1, 1, ['
               ...
               assign o_csr_imm = $imm_b19_b12_b20[4];
                  ...
                  '], ['
                     assign o_rd_addr  = $rd_addr_w1;
                     assign o_rs1_addr = $rs1_addr_w1;
                     assign o_rs2_addr = $rs2_addr_w1;
                  '])
