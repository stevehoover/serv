         ...
         \SV_plus
            ...
            generate
               ...
               always \@(posedge i_clk) begin
                  ...
                  {i19, i18, i17} <= i_cnt_en ? {(i_ctrl[3] ? signbit : i23), (i_ctrl[3] ? signbit : i22), (i_ctrl[3] ? signbit : i21)} :
                  ...
                  {i30, i29, i28} <= i_cnt_en ? {((i_ctrl[1] | i_ctrl[2]) ? signbit : i14), ((i_ctrl[1] | i_ctrl[2]) ? signbit : i13), ((i_ctrl[1] | i_ctrl[2]) ? signbit : i12)} :
