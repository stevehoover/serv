...
generate
   ...
   wire       signbit = imm31 & !i_csr_imm_en;
      ...
      if (SHARED_RFADDR_IMM_REGS) begin : gen_shared_addr_out
         ...
         assign o_rd_addr  = gen_separate_imm_regs.rd_addr;
         assign o_rs1_addr = gen_separate_imm_regs.rs1_addr;
         assign o_rs2_addr = gen_separate_imm_regs.rs2_addr;
      end
   ...
   assign o_imm[0] = i_ctrl[0] ? ii7_b2 : ii20_b2;
