...
// The guts of module serv_immdec.
\TLV serv_immdec(/_top)
   |default
      @0
         ...
         // Immediate register assignments for W=1
         m5_if_eq_block(m5_cond_w_1, 1, ['
         ...
         {<<1$rs2_addr_w1[4:0], <<1$rs1_addr_w1[4:0], <<1$rd_addr_w1[4:0]} = $wb_en ? {$wb_rdt[24:20], $wb_rdt[19:15], $wb_rdt[11:7]} : {$rs2_addr_w1, $rs1_addr_w1, $rd_addr_w1};
         
         <<1$imm7 = $cnt_en ? $signbit :
                     $wb_en ? $wb_rdt[7] : 
                              $imm7;
         
         {<<1$imm_b24_b20[4:0], <<1$imm_b11_b7[4:0]} = $cnt_en ? {{$imm_b30_b25[0], $imm_b24_b20[4:1]}, {$imm_b30_b25[0], $imm_b11_b7[4:1]}} :
