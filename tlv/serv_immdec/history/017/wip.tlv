      ...
      @0
         ...
         \SV_plus
            ...
            generate
               ...
               assign /gen_w_eq1[#gen_w1]$$signbit = imm31 & !i_csr_imm_en;
                  ...
                  for (gen_shared = !SHARED_RFADDR_IMM_REGS; gen_shared < 1; gen_shared++) begin : gen_shared_imm_regs
                     always \@(posedge i_clk) begin
                        ...
                        if (i_wb_en | (i_cnt_en & i_immdec_en[1]))
                          imm_b19_b12_b20 <= i_wb_en ? {i_wb_rdt[19:12],i_wb_rdt[20]} : {i_ctrl[3] ? /gen_w_eq1[#gen_w1]$signbit : imm_b24_b20[0], imm_b19_b12_b20[8:1]};
                        if (i_wb_en | (i_cnt_en))
                          imm7        <= i_wb_en ? i_wb_rdt[7]                    : /gen_w_eq1[#gen_w1]$signbit;
            
                        if (i_wb_en | (i_cnt_en & i_immdec_en[3]))
                          imm_b30_b25    <= i_wb_en ? i_wb_rdt[30:25] : {i_ctrl[2] ? imm7 : i_ctrl[1] ? /gen_w_eq1[#gen_w1]$signbit : imm_b19_b12_b20[0], imm_b30_b25[5:1]};
                  ...
                  for (gen_separate = SHARED_RFADDR_IMM_REGS; gen_separate < 1; gen_separate++) begin : gen_separate_imm_regs
                     ...
                     always \@(posedge i_clk) begin
                        ...
                        if (i_cnt_en) begin
                           imm_b19_b12_b20 <= {i_ctrl[3] ? /gen_w_eq1[#gen_w1]$signbit : imm_b24_b20[0], imm_b19_b12_b20[8:1]};
                           imm7        <= /gen_w_eq1[#gen_w1]$signbit;
                           imm_b30_b25    <= {i_ctrl[2] ? imm7 : i_ctrl[1] ? /gen_w_eq1[#gen_w1]$signbit : imm_b19_b12_b20[0], imm_b30_b25[5:1]};
               ...
               assign /gen_w_eq4[#gen_w4]$$signbit = i31 & !i_csr_imm_en;
               ...
               always \@(posedge i_clk) begin
                  ...
                  if (i_cnt_en) begin
                     ...
                     i10 <= i27;
                     i23 <= i27;
                     i27 <= i_ctrl[2] ? i7 : i_ctrl[1] ? /gen_w_eq4[#gen_w4]$signbit : i20;
                     i7  <= /gen_w_eq4[#gen_w4]$signbit;
                     i20 <= i15;
                     i15 <= i19;
                     i19 <= i_ctrl[3] ? /gen_w_eq4[#gen_w4]$signbit : i23;
            
                     //Bit lane 2
                     i22 <= i26;
                     i9  <= i26;
                     i26 <= i30;
                     i30 <= (i_ctrl[1] | i_ctrl[2]) ? /gen_w_eq4[#gen_w4]$signbit : i14;
                     i14 <= i18;
                     i18 <= i_ctrl[3] ? /gen_w_eq4[#gen_w4]$signbit : i22;
            
                     //Bit lane 1
                     i21 <= i25;
                     i8  <= i25;
                     i25 <= i29;
                     i29 <= (i_ctrl[1] | i_ctrl[2]) ? /gen_w_eq4[#gen_w4]$signbit : i13;
                     i13 <= i17;
                     i17 <= i_ctrl[3] ? /gen_w_eq4[#gen_w4]$signbit : i21;
                     ...
                     ii20_b2   <= i24;
                     i24   <= i28;
                     i28   <= (i_ctrl[1] | i_ctrl[2]) ? /gen_w_eq4[#gen_w4]$signbit : i12;
                     i12   <= i16;
                     i16   <= i_ctrl[3] ? /gen_w_eq4[#gen_w4]$signbit : ii20_b2;
            ...
            generate
               ...
               for (gen_w1_imm = (W != 1); gen_w1_imm < 1; gen_w1_imm++) begin : gen_w1_imm_out
                  assign o_imm = i_cnt_done ? /gen_w_eq1[0]$signbit : i_ctrl[0] ? gen_immdec_w_eq1[0].imm_b11_b7[0] : gen_immdec_w_eq1[0].imm_b24_b20[0];
               end
               // if (W != 1)
               genvar gen_w4_imm;
               for (gen_w4_imm = (W == 1); gen_w4_imm < 1; gen_w4_imm++) begin : gen_w4_imm_out
                  assign o_imm = {(i_cnt_done ? /gen_w_eq4[0]$signbit : (i_ctrl[0] ? gen_immdec_w_eq4[0].i10 : gen_immdec_w_eq4[0].i23)),
