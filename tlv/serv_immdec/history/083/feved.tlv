         ...
         \SV_plus
            ...
            generate
                  ...
                  for (gen_separate = SHARED_RFADDR_IMM_REGS; gen_separate < 1; gen_separate++) begin : gen_separate_imm_regs
                     ...
                     always \@(posedge i_clk) begin
                        ...
                        if (i_cnt_en) begin
                           ...
                           // Move imm7 to AFTER imm_b30_b25 to preserve dependency order
                        ...
                        // Convert imm7 to ternary but place it after dependencies
               ...
               always \@(posedge i_clk) begin
                  ...
                  rs2_addr <= i_wb_en ? i_wb_rdt[24:20] : rs2_addr;
                  rd_addr <= i_wb_en ? i_wb_rdt[11:7] : rd_addr;
                  ii7_b2  <= i_wb_en ? i_wb_rdt[7] : ii7_b2;
                  ii20_b2 <= i_wb_en ? i_wb_rdt[20] : ii20_b2;
