      ...
      @0
         \SV_plus
           ...
           /*  If i_iscomp=1: increment program_counter by 2 else increment program_counter by 4  */
            ...
            // Convert generate if to generate for (executes 1 time if W > 1, 0 times if W <= 1)
            generate
               genvar gen_w_gt_1_var;
               for (gen_w_gt_1_var = (W <= 1); gen_w_gt_1_var < 1; gen_w_gt_1_var++) begin : gen_w_gt_1
