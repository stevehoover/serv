...
//_\TLV
   ...
   //_\source wip.tlv 7   // Instantiated from wip.tlv, 119 as: m5+serv_ctrl_logic(/top)
      //_|default
         //_@0
            ...
            assign DEFAULT_o_ibus_adr_next_a0[31:0] = (RESET_STRATEGY == "NONE") ?
                                        (DEFAULT_i_pc_en_a0 ? {DEFAULT_new_pc_a0, DEFAULT_o_ibus_adr_input_a0[31 : W]} : DEFAULT_o_ibus_adr_input_a0) :
                                        ((DEFAULT_i_pc_en_a0 | DEFAULT_reset_a0) ?
                                           (DEFAULT_reset_a0 ? RESET_PC : {DEFAULT_new_pc_a0, DEFAULT_o_ibus_adr_input_a0[31 : W]}) :
      ...
      //_@0
         ...
         /*SV_plus*/
            ...
            always @(posedge clk) begin
               ...
               o_ibus_adr <= DEFAULT_o_ibus_adr_next_a0;
            end
//_\SV
endmodule
