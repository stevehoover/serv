   ...
   |default
      @0
         ...
         \SV_plus
            ...
            assign $$co_ext_funct3[2:0] = funct3;
         ...
         \SV_plus
            generate
               genvar gen_pre_reg;
               for (gen_pre_reg = PRE_REGISTER == 0; gen_pre_reg < 1; gen_pre_reg++) begin : gen_pre_register
               ...
               genvar gen_post_reg;
               for (gen_post_reg = PRE_REGISTER == 1; gen_post_reg < 1; gen_post_reg++) begin : gen_post_register
